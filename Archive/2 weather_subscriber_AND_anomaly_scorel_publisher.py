...
class WeatherSubscriberANDAnomalyScorePublisher:
    ...
    def __init__(self, sub_topic="test8_noaa-reports-json", pub_topic="test2_score"):
    ...
    def reset_all_process(self):
        ...
        self.hst = anomaly.HalfSpaceTrees(n_trees=20, height=5, window_size=3)
    ...
    async def handle_event(self, event):
        ...
        # Check whether the data duplicate
